...
export const MagicWandIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="m5 9.5 2.5-2.5" />
    <path d="M19.5 14.5 17 12" />
    <path d="m14 19.5-2.5-2.5" />
    <path d="M9 22v-2" />
    <path d="M4 15H2" />
    <path d="M22 9h-2" />
    <path d="m20 5-2.5 2.5" />
    <path d="M4 20l2.5-2.5" />
    <path d="M9 4.5 6.5 7" />
    <path d="m12.5 17-5 5" />
    <path d="m8.5 7.5 10 10" />
  </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M5 5l1 1"/><path d="M18 5l1 1"/><path d="M5 18l1 1"/><path d="M18 18l1 1"/>
    <path d="M9 3h6"/><path d="M9 21h6"/><path d="M3 9v6"/><path d="M21 9v6"/>
  </svg>
);
...
export const WindIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
